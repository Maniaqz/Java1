...
public class Main {
    ...
    private static void doAiTurn(int row, int column) {
        System.out.format("Компьютер произвёл ход в ячейку %s %s %n", row + 1, column + 1);
    ...
    private static void humanTurn() {
        int row;
        int column;
        do { System.out.format("Введите значение строки и столбца," +
